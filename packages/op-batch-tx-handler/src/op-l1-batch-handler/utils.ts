...
export const processRawData = (rawData: Uint8Array): Uint8Array => {
  ...
  const frameDataLength = rawData.subarray(1 + ChannelIdSize + FrameNumberSize,
					   1 + ChannelIdSize + FrameNumberSize + FrameDataLengthSize);
  console.log("frameDataLength: ", ethers.utils.hexlify(frameDataLength));
